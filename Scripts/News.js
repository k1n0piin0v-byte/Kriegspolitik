    ...
    loadNews() {
        this.news = [
            ...
            },
            {
                date: '17.10.2025',
                title: 'Патч 1.1',
                content: 'В этом обновлении мы представляем не значительные визуальные улучшения интерфейса. Также была добавлена механика Индекса в регионах - теперь учитывается больше факторов влияния, включая экономическую активность, политическую стабильность и уровень поддержки населения. Кроме того, введены: Законопроекты, Военные Формулирования (Частные, под управлением игрока и npc), Внешняя Политика для стран и усовершенствованная Механика Войн с расширенной системой тактических возможностей.'
            }
        ];
